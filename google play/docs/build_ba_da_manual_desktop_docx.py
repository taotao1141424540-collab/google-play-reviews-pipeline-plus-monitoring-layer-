#!/usr/bin/env python3
"""Write ~/Desktop/Google_Play_BA_DA_小白行动手册.docx from BA_DA_小白行动手册.md.

Requires: pip install python-docx
Run from repo root:
  .venv/bin/python "google play/docs/build_ba_da_manual_desktop_docx.py"
"""
...
MD_PATH = HERE / "BA_DA_小白行动手册.md"
DOCX_PATH = Path.home() / "Desktop" / "Google_Play_BA_DA_小白行动手册.docx"
...
def md_to_docx(md_text: str, out_path: Path) -> None:
    ...
    r_note = p_note.add_run(
        "说明：本文件为 Word 使用的 .docx 格式（Office Open XML）。"
        "源文件：仓库内 google play/docs/BA_DA_小白行动手册.md"
    )
