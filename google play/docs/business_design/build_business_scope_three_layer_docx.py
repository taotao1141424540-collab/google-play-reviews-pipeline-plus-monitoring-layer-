#!/usr/bin/env python3
"""Write business_scope_three_layer_design.docx from business_scope_three_layer_design.md.

Requires: pip install python-docx

Run from repo root:
  python3 "google play/docs/business_design/build_business_scope_three_layer_docx.py"
"""
...
MD_PATH = HERE / "business_scope_three_layer_design.md"
DOCX_PATH = HERE / "business_scope_three_layer_design.docx"
...
def md_to_docx(md_text: str, out_path: Path) -> None:
    ...
    r_note = p_note.add_run(
        "说明：本文件由 Markdown 转换生成。源文件：google play/docs/business_design/business_scope_three_layer_design.md"
    )
